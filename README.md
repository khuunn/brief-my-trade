...
- 📈 **미실현손익** — 현재가 실시간 조회 후 포지션 평가 (Naver Finance + yfinance)
- 📊 **Overview** — 실현+미실현 합산 계좌 현황, 기간 선택 인라인 버튼
...
| `/today` | 오늘 거래 요약 |
| `/week` | 이번 주 실현손익 |
| `/portfolio` | 보유 포지션 + 미실현손익 (종목별) |
| `/overview` | 계좌 현황 — 실현+미실현 합산, 기간 선택 버튼 |
| `/overview week` | 이번 주 기준 계좌 현황 |
| `/overview 3m` | 최근 3개월 기준 계좌 현황 |
| `/overview 2026-01-01 2026-03-05` | 기간 직접 지정 |
| `/pnl` | 이번달 실현손익 |
| `/pnl 2026-01-01 2026-03-31` | 기간 지정 실현손익 |
| `/pnl week` | 이번 주 실현손익 |
| `/pnl ytd` | 연초부터 실현손익 |
| `/report` | 주간 마크다운 보고서 |
| `/capital` | 자본금 현황 |
